 ...
 * @file: Name of a file buffer is storing chars for.
 *
 ...
 * If file_from does not exist or fails to be read - exit code 98.
 * If file_to fails to be created or written to - exit code 99.
 * If file_to or file_from fails to be closed - exit code 100.
 */
